export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenCMS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenCMS wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
