export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenCMS",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenCMS er lastet ned. Vil du installere den og starte på nytt?",
