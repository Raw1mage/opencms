export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenCMS",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenCMS a été téléchargée. Voulez-vous l'installer et redémarrer ?",
