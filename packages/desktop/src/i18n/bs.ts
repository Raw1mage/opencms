export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenCMS-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenCMS-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
