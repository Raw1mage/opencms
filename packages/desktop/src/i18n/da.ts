export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenCMS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenCMS er blevet downloadet. Vil du installere den og genstarte?",
