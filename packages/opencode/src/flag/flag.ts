...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_SMART_RUNNER_GOVERNOR =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_SMART_RUNNER_GOVERNOR")
  export const OPENCODE_EXPERIMENTAL_SMART_RUNNER_GOVERNOR_ASSIST =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_SMART_RUNNER_GOVERNOR_ASSIST")
