                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            Manage your connected provider accounts and switch active state.
                        </p>
                    </div>
                    <button
                        onClick={() => refetch()}
                                                        ...
                                                        <div class="p-5 flex items-center justify-between hover:bg-gray-50/50 transition-colors">
                                                            ...
                                                            <div class="ml-4 flex-shrink-0">
                                                                <button
                                                                    ...
                                                                    disabled={isActive}
                                                                    class={`inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold shadow-sm ring-1 ring-inset transition-all ${isActive
