...
export class File extends HeyApiClient {
  ...
  /**
   * Upload file into active-project directory
   *
  ...
  /**
   * Download file from active project
   *
   ...
   * Upload a single file via multipart/form-data into the given active-project parent directory. Browser-supplied filename basename is used; embedded path separators are rejected. Duplicate destinations and oversize payloads are rejected.
   */
  public upload2<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      parent?: string
      file?: Blob | File
    ...
    return (options?.client ?? this.client).post<FileUpload2Responses, unknown, ThrowOnError>({
      ...formDataBodySerializer,
      url: "/file/upload",
      ...options,
      ...params,
   ...
   * Stream the bytes of an active-project file. Directory targets are rejected with FILE_DOWNLOAD_DIRECTORY_UNSUPPORTED. Symlinks whose realpath leaves the project are rejected with FILE_OP_PATH_ESCAPE.
   */
  public download2<ThrowOnError extends boolean = false>(
    parameters: {
      directory?: string
      path: string
    },
    ...
    return (options?.client ?? this.client).get<FileDownload2Responses, unknown, ThrowOnError>({
      url: "/file/download",
      ...options,
      ...params,
    })
