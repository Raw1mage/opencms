...
export type ProjectSidebarContext = {
  ...
  navigateToProject: (directory: string, options?: { sessionList?: boolean; keepMobileSidebarOpen?: boolean }) => void
    ...
    >
      <ContextMenu.Trigger
        ...
        onClick={() => {
          ...
          props.navigateToProject(props.project.worktree, { sessionList: true, keepMobileSidebarOpen: true })
        }}
