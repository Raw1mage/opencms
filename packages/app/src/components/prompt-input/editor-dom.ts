import { type Prompt, DEFAULT_PROMPT, type FileAttachmentPart, type AgentPart } from "@/context/prompt"
...
export function isNormalizedEditor(editorRef: HTMLElement) {
...
export function renderEditor(editorRef: HTMLElement, parts: Prompt) {
  editorRef.innerHTML = ""
