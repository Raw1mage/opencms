...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OpenCMS 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OpenCMS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 並手動開啟連結取得授權碼，以連線你的帳戶並在 OpenCMS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "，手動開啟後輸入以下程式碼，以連線你的帳戶並在 OpenCMS 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 OpenCMS 伺服器。",
  ...
  "toast.update.description": "OpenCMS 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 OpenCMS 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: OpenCMS 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "OpenCMS 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 OpenCMS 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 OpenCMS 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OpenCMS 的主題。",
  ...
  "settings.updates.row.startup.description": "在 OpenCMS 啟動時自動檢查更新",
