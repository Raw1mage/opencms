...
python3 <skill-path>/scripts/sync_datasheets_element14.py <file.kicad_sch> --force-all
...
**MPN-list batch mode** — when you have a list of MPNs but no
...
`ELEMENT14_API_KEY` is still required even in dry-run mode.
