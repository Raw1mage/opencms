...
# Add the kicad analysis engine scripts to path for shared imports. The engine
# now lives under the bodesign skill; fall back to a standalone kicad skill.
_here = os.path.dirname(os.path.abspath(__file__))
for _kicad_scripts in (os.path.join(_here, '..', '..', 'bodesign', 'engines', 'kicad', 'scripts'),
                       os.path.join(_here, '..', '..', 'kicad', 'scripts')):
