...
from datasheet_extract_cache import _sanitize_mpn  # noqa: E402  (shared MPN→filename rule)
...
def _load_extraction(extract_dir: str, mpn: str) -> dict:
    ...
    # Match the cache's filename rule ({clean}_{md5[:6]}); a bare regex sanitize
    # never matches the suffixed files cache_extraction writes.
