...
- `packages/app/src/components/model-selector-state.test.ts`
  - 更新/補充 provider row 測試，驗證 user-controlled favorites 語意。
...
- `bun test /home/pkcs12/projects/opencode/packages/app/src/components/model-selector-state.test.ts` ✅（16 pass / 0 fail）
